...
public class HUDHandlerBCTanks implements IWailaDataProvider {
    ...
    {
        FluidTankInfo tank = getTank(accessor);
    ...
    public FluidTankInfo getTank(IWailaDataAccessor accessor)
    {
        ...
        try
        {
            tank = ((FluidTankInfo[])(FluidTankInfo[])BCModule.TileTank_getTankInfo.invoke(BCModule.TileTank.cast(accessor.getTileEntity()), new Object[] { net.minecraftforge.common.util.ForgeDirection.UNKNOWN }))[0];
        }
        catch (Exception e)
        {
